...
# Comunicación directa entre agentes dentro de un run (v2).
class AgentMessage(Base):
    ...
    from_agent_name: Mapped[str] = mapped_column(String(128))
    to_agent: Mapped[str] = mapped_column(String(128))  # nombre del destinatario o "all"
